...
iMH=0 # switch for generating data for a Delta chi^2_min vs. delta_CP plot
ichi2_CP=0 # switch for generating data for a chi^2_min vs. delta_CP plot
ichi2_th23=1 # switch for generating data for a chi^2_min vs. th23 plot
...
#    run_name=T2HKK_2.5_2.3_1040km_chi2-CP_noKr_2SV
    run_name=T2HKK_2.5_2.3_1040km_chi2-CP
#    run_name=T2HKK_2.5_1.3_1090km_chi2-CP_2
#    run_name=test
    ./makedir.sh rslt_$run_name 1
...
#    run_name=T2HKK_2.5_1.3_1090km_chi2-th23
    ./makedir.sh rslt_$run_name 1
